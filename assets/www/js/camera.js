...
function fillSettingsInfo(infoDivName) {
    ...
    if (settingsInfo != null) {
        settingsInfo.innerHTML += "<h3>Settings: </h3>" +
                                 "<table>" +
                                 "<tr><td class='bh'>Opções da edição: </td></tr>" + 
                                 ...
                                 "<tr><td class='bi'>Permitir zoom de imagem:</td><td>" + ((settings.allowEdit == true) ? "Yes" : "No") + "</td></tr>" + 
                                 "<tr><td class='bi'>Orientação:</td><td>" + ((settings.correctOrientation == true) ? "Yes" : "No") + "</td></tr>" +
                                 "<tr><td class='bh'>Saving options: </td></tr>" + 
                                 "<tr><td class='bi'>Tipo de arquivo:</td><td>" + settingsBatch.elements["encod_input"].options[settings.encodingType].innerHTML + "</td></tr>" +
